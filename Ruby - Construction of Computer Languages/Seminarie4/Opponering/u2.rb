...
class ConstraintParser < Parser
  ...
  def initialize
    ...
    @parser=super("constraints") do
      ...
      rule :expr do
        #Vid varje matchning av +/- returnerar vi conn_c som en connector.
  ...
  #Laggt till denna funktion, som returnarar resultatet av conn om denne är en ArithmeticConstraint.
